...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("com.alextarasyuk", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("com.alextarasyuk", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "84";
		app.meta["company"] = "OTarasiuk";
		app.meta["file"] = "com.alextarasyuk";
		app.meta["name"] = "com.alextarasyuk";
		app.meta["packageName"] = "com.alextarasyuk";
